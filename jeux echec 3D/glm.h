...
GLvoid
glmDraw2(GLMmodel* model, GLuint mode);
GLvoid
glmDraw22(GLMmodel* model, GLuint mode);
//glmDraw2(GLMmodel* model,char *nomDuGroup,float translate_x,float translate_y,float translate_z, GLuint mode);
